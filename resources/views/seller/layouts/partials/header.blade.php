...
<nav class="main-header navbar navbar-expand navbar-white navbar-light navbar-fixed">
    ...
    <ul class="navbar-nav">
        ...
        <div class="hidden sm:-my-px  sm:flex">
            <a href="{{ route('sellers.dashboard') }}" class="nav-link">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <!-- Settings Dropdown -->
        <li class="nav-item dropdown">
            <a href="{{ route('sellers.dashboard') }}" class="nav-link" data-toggle="dropdown">
                <div>
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                <a href="{{ route('sellers.profile.edit') }}" class="dropdown-item">
                ...
                <form method="POST" action="{{ route('sellers.logout') }}">
                    @csrf
                    <a href="{{ route('sellers.logout') }}" class="dropdown-item"
